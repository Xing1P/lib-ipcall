...
import vn.rta.ipcall.ui.indicators.BallScaleMultipleIndicator;
import vn.rta.survey.android.R;

/**
 * Created by Genius Doan on 2017/5/10
 */

public class CallLoadingIndicatorView extends View {

    private static final String TAG = CallLoadingIndicatorView.class.getSimpleName();

    private static final BallScaleMultipleIndicator DEFAULT_INDICATOR = new BallScaleMultipleIndicator();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.CallLoadingIndicatorView, defStyleAttr, defStyleRes);

        mMinWidth = a.getDimensionPixelSize(R.styleable.CallLoadingIndicatorView_minWidth, mMinWidth);
