...
public class SipProfile implements Parcelable {
     ...
     * Note that in linphone this value is not applied anymore in flavor to
     ...
     * @see #FIELD_TRANSPORT
     */
    public LinphoneAddress.TransportType transport = LinphoneAddress.TransportType.LinphoneTransportUdp;
    /**
    ...
    private SipProfile(Parcel in) {
        ...
        transport = LinphoneAddress.TransportType.fromInt(in.readInt());
    ...
    private final void createFromContentValue(ContentValues args) {
        ...
        if (tmp_i != null) {
            transport = LinphoneAddress.TransportType.fromInt(tmp_i);
        }
...
//        Log.d("test dbcontent ","FIELD_DEFAULT_URI_SCHEME " + default_uri_scheme);

        args.put(FIELD_WIZARD_DATA, wizard_data);
//        Log.d("test dbcontent ","FIELD_WIZARD_DATA " + wizard_data);


        args.put(FIELD_PRIORITY, priority);
//        Log.d("test dbcontent ","FIELD_PRIORITY " + priority);
        args.put(FIELD_ACC_ID, acc_id);
//        Log.d("test dbcontent ","FIELD_ACC_ID " + acc_id);
        args.put(FIELD_REG_URI, reg_uri);
//        Log.d("test dbcontent ","FIELD_REG_URI " + reg_uri);

        args.put(FIELD_PUBLISH_ENABLED, publish_enabled);
//        Log.d("test dbcontent ","FIELD_PUBLISH_ENABLED " + publish_enabled);
        args.put(FIELD_REG_TIMEOUT, reg_timeout);
//        Log.d("test dbcontent ","FIELD_REG_TIMEOUT " + reg_timeout);
        args.put(FIELD_KA_INTERVAL, ka_interval);
//        Log.d("test dbcontent ","FIELD_KA_INTERVAL " + ka_interval);
        args.put(FIELD_PIDF_TUPLE_ID, pidf_tuple_id);
//        Log.d("test dbcontent ","FIELD_WIZARD " + wizard);
        args.put(FIELD_FORCE_CONTACT, force_contact);
//        Log.d("test dbcontent ","FIELD_FORCE_CONTACT " + force_contact);
        args.put(FIELD_ALLOW_CONTACT_REWRITE, allow_contact_rewrite ? 1 : 0);
//        Log.d("test dbcontent ","FIELD_ALLOW_CONTACT_REWRITE " + allow_contact_rewrite);
        args.put(FIELD_ALLOW_VIA_REWRITE, allow_via_rewrite ? 1 : 0);
//        Log.d("test dbcontent ","FIELD_ALLOW_VIA_REWRITE " + allow_via_rewrite);
        args.put(FIELD_ALLOW_SDP_NAT_REWRITE, allow_sdp_nat_rewrite ? 1 : 0);
//        Log.d("test dbcontent ","FIELD_ALLOW_SDP_NAT_REWRITE " + allow_sdp_nat_rewrite);
        args.put(FIELD_CONTACT_REWRITE_METHOD, contact_rewrite_method);
//        Log.d("test dbcontent ","FIELD_CONTACT_REWRITE_METHOD " + contact_rewrite_method);
        args.put(FIELD_USE_SRTP, use_srtp);
//        Log.d("test dbcontent ","FIELD_USE_SRTP " + use_srtp);
        args.put(FIELD_USE_ZRTP, use_zrtp);
//        Log.d("test dbcontent ","FIELD_USE_ZRTP " + use_zrtp);

        // CONTACT_PARAM and CONTACT_PARAM_URI not yet in JNI

        if (proxies != null) {
            args.put(FIELD_PROXY, TextUtils.join(PROXIES_SEPARATOR, proxies));
//            Log.d("test dbcontent ","FIELD_PROXY " +  TextUtils.join(PROXIES_SEPARATOR, proxies));
        } else {
            args.put(FIELD_PROXY, "");
//            Log.d("test dbcontent ","FIELD_PROXY " + "");
        }
        args.put(FIELD_REG_USE_PROXY, reg_use_proxy);
//        Log.d("test dbcontent ","FIELD_REG_USE_PROXY " + reg_use_proxy);
        // Assume we have an unique credential
        args.put(FIELD_REALM, realm);
//        Log.d("test dbcontent ","FIELD_REALM " + realm);
        args.put(FIELD_SCHEME, scheme);
//        Log.d("test dbcontent ","FIELD_SCHEME " + scheme);
        args.put(FIELD_USERNAME, username);
//        Log.d("test dbcontent ","FIELD_USERNAME " + username);
...
//        Log.d("test dbcontent ","FIELD_SIP_STACK " + sip_stack);
        args.put(FIELD_MWI_ENABLED, mwi_enabled);
//        Log.d("test dbcontent ","FIELD_MWI_ENABLED " + mwi_enabled);
        args.put(FIELD_VOICE_MAIL_NBR, vm_nbr);
//        Log.d("test dbcontent ","FIELD_VOICE_MAIL_NBR " + vm_nbr);
        args.put(FIELD_REG_DELAY_BEFORE_REFRESH, reg_delay_before_refresh);
//        Log.d("test dbcontent ","FIELD_REG_DELAY_BEFORE_REFRESH " + reg_delay_before_refresh);
        args.put(FIELD_TRY_CLEAN_REGISTERS, try_clean_registers);
//        Log.d("test dbcontent ","FIELD_TRY_CLEAN_REGISTERS " + try_clean_registers);


        args.put(FIELD_RTP_BOUND_ADDR, rtp_bound_addr);
//        Log.d("test dbcontent ","FIELD_RTP_BOUND_ADDR " + rtp_bound_addr);
        args.put(FIELD_RTP_ENABLE_QOS, rtp_enable_qos);
//        Log.d("test dbcontent ","FIELD_RTP_ENABLE_QOS " + rtp_enable_qos);
        args.put(FIELD_RTP_PORT, rtp_port);
//        Log.d("test dbcontent ","FIELD_RTP_PORT " + rtp_port);
        args.put(FIELD_RTP_PUBLIC_ADDR, rtp_public_addr);
//        Log.d("test dbcontent ","FIELD_RTP_PUBLIC_ADDR " + rtp_public_addr);
        args.put(FIELD_RTP_QOS_DSCP, rtp_qos_dscp);
//        Log.d("test dbcontent ","FIELD_RTP_QOS_DSCP " + rtp_qos_dscp);

        args.put(FIELD_VID_IN_AUTO_SHOW, vid_in_auto_show);
//        Log.d("test dbcontent ","FIELD_VID_IN_AUTO_SHOW " + vid_in_auto_show);
        args.put(FIELD_VID_OUT_AUTO_TRANSMIT, vid_out_auto_transmit);
//        Log.d("test dbcontent ","FIELD_VID_OUT_AUTO_TRANSMIT " + vid_out_auto_transmit);

        args.put(FIELD_RFC5626_INSTANCE_ID, rfc5626_instance_id);
//        Log.d("test dbcontent ","FIELD_RFC5626_INSTANCE_ID " + rfc5626_instance_id);
        args.put(FIELD_RFC5626_REG_ID, rfc5626_reg_id);
//        Log.d("test dbcontent ","FIELD_RFC5626_REG_ID " + rfc5626_reg_id);
        args.put(FIELD_USE_RFC5626, use_rfc5626 ? 1 : 0);
//        Log.d("test dbcontent ","FIELD_USE_RFC5626 " + use_rfc5626);

        args.put(FIELD_ANDROID_GROUP, android_group);
//        Log.d("test dbcontent ","FIELD_WIZARD " + wizard);

        args.put(FIELD_SIP_STUN_USE, sip_stun_use);
//        Log.d("test dbcontent ","FIELD_SIP_STUN_USE " + sip_stun_use);
        args.put(FIELD_MEDIA_STUN_USE, media_stun_use);
//        Log.d("test dbcontent ","FIELD_MEDIA_STUN_USE " + media_stun_use);
        args.put(FIELD_ICE_CFG_USE, ice_cfg_use);
//        Log.d("test dbcontent ","FIELD_ICE_CFG_USE " + ice_cfg_use);
        args.put(FIELD_ICE_CFG_ENABLE, ice_cfg_enable);
//        Log.d("test dbcontent ","FIELD_IC/E_CFG_ENABLE " + ice_cfg_enable);
        args.put(FIELD_TURN_CFG_USE, turn_cfg_use);
//        Log.d("test dbcontent ","FIELD_TURN_CFG_USE " + turn_cfg_use);
        args.put(FIELD_TURN_CFG_ENABLE, turn_cfg_enable);
//        Log.d("test dbcontent ","FIELD_TURN_CFG_ENABLE " + turn_cfg_enable);
        args.put(FIELD_TURN_CFG_SERVER, turn_cfg_server);
//        Log.d("test dbcontent ","FIELD_TURN_CFG_SERVER " + turn_cfg_server);
        args.put(FIELD_TURN_CFG_USER, turn_cfg_user);
//        Log.d("test dbcontent ","FIELD_TURN_CFG_USER " + turn_cfg_user);
        args.put(FIELD_TURN_CFG_PASSWORD, turn_cfg_password);
//        Log.d("test dbcontent ","FIELD_TURN_CFG_PASSWORD " + turn_cfg_password);

        args.put(FIELD_IPV6_MEDIA_USE, ipv6_media_use);
//        Log.d("test dbcontent ","FIELD_IPV6_MEDIA_USE " + ipv6_media_use);
