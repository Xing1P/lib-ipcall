...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "com.rta.ipcall.service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = "com.rta.ipcall.service.SipService";
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "com.rta.ipcall.accounts.activate";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "com.rta.ipcall.phone.action.INCALL";
    public static final String ACTION_SIP_CALL_FLOATING_UI = "vn.rta.sipcall.service";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "com.rta.ipcall.phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "com.rta.ipcall.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "com.rta.ipcall.phone.action.MESSAGES";
    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = "com.rta.ipcall.phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = "com.rta.ipcall.ui.action.PREFS_FAST";
    /**
     * Action launched to enter global linphone settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "com.rta.ipcall.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_LAUNCH = "com.rta.ipcall.service.CALL_LAUNCHED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "com.rta.ipcall.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "com.rta.ipcall.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_DELETED = "com.rta.ipcall.service.ACCOUNT_DELETED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "com.rta.ipcall.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "com.rta.ipcall.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "com.rta.ipcall.service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = "com.rta.ipcall.service.MESSAGE_RECEIVED";
    /**
     * Broadcast sent when a conversation has been recorded.<br/>
     * This is linked to the call record feature of Linphone available through {@link ISipService#startRecording(int)}
     * <p>
     * Provided extras :
     * <ul>
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "com.rta.ipcall.service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "com.rta.ipcall.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "com.rta.ipcall.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "com.rta.ipcall.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "com.rta.ipcall.service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "com.rta.ipcall.themes.GET_DRAWABLES";
    /**
     ...
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "com.rta.ipcall.phone.action.HANDLE_CALL";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "com.rta.ipcall.sipcall.action.HANDLE_CALL_PLUGIN";

    public static final String EXTRA_SIP_CALL_MIN_STATE = "com.rta.ipcall.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "com.rta.ipcall.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "com.rta.ipcall.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "com.rta.ipcall.phone.action.REWRITE_NUMBER";
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "com.rta.ipcall.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "com.rta.ipcall.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "com.rta.ipcall.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = BuildConfig.FLAVOR + ".rta.ipcall.db";
    /**
     * Base content type for linphone objects.
     */
    public static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.rta.ipcall";
    /**
     * Base item content type for linphone objects.
     */
    public static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.rta.ipcall";
