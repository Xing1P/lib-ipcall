...
public class SipConfigManager {
     ...
     * @see MediaRecorder.AudioSource#VOICE_CALL
     * @see MediaRecorder.AudioSource#VOICE_COMMUNICATION
     * @see MediaRecorder.AudioSource#VOICE_DOWNLINK
     * @see MediaRecorder.AudioSource#VOICE_RECOGNITION
     * @see MediaRecorder.AudioSource#VOICE_UPLINK
     */
