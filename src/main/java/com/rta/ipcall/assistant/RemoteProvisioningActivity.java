package com.rta.ipcall.assistant;
/*
...
import com.rta.ipcall.LinphoneLauncherActivity;
...
public class RemoteProvisioningActivity extends Activity {
	...
	private void goToLinphoneActivity() {
		if (LinphoneService.isReady()) {
			LinphoneService.instance().setActivityToLaunchOnIncomingReceived("com.rta.ipcall.LinphoneLauncherActivity");
